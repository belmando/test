...
<body>
<form method="POST" action="https://landscapesco.activehosted.com/proc.php" id="_form_3_"
    ...
    <div class="_form-content">
        <div class="_form_element _x65457909 _full_width ">
        ...
        <div class="_form_element _x10564922 _full_width ">
            <label class="_form-label">
                Телефон
            </label>
            <div class="_field-wrapper">
        ...
        <div class="_form_element _x99954920 _full_width ">
            <label class="_form-label">
                Email*
            </label>
            <div class="_field-wrapper">
    ...
    (function () {
        ...
        var form_submit = function (e) {
            ...
            if (validate_form()) {
                ...
                _load_script('https://landscapesco.activehosted.com/proc.php?' + serialized + '&jsonp=true');
            }
            return false;
        };
